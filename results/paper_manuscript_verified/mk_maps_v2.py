...
NUM = [
 ...
 ("Abstract", "about -19.8%", "rounded from G = -19.76 at the direct-favourable cell", S2C, "gain", "rounding of a mapped value", "see the 4.8 row"),
 ("Abstract", "11.87 percentage points", "H2 win-rate difference", T4, "reading column", "see the 5.6 row", "see the 5.6 row"),
 ("Abstract/Introduction", "3.152 / 4.202 / 4.220 (referenced qualitatively)", "classical estimators outrank both neural arms", PO + "/detailed_outline.md sec 5.2", "classical_benchmark/benchmark.json", "mean rank", "none"),
...
p2 = os.path.join(MO, "manuscript_v2_reference_map.csv")
...
print("manuscript_v2_reference_map.csv:", len(keys), "keys", keys)
