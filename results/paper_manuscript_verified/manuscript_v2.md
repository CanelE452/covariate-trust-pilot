...
<!-- ===== Abstract  (source: abstract_v2.md) ===== -->
...
<!-- ===== 3 + 4.1-4.5 Setup and synthetic design  (source: methods_v1.md (part A)) ===== -->
...
<!-- ===== 4.6-4.8 Synthetic results  (source: results_v1.md (part A)) ===== -->
...
<!-- ===== 5.1-5.3 Empirical design  (source: methods_v1.md (part B)) ===== -->
...
<!-- ===== 5.4-5.9 Empirical results  (source: results_v1.md (part B)) ===== -->
...
<!-- ===== 6 Discussion  (source: discussion_v2.md) ===== -->
