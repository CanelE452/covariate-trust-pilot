...
────────────────────────────────────────────────────────────────────────────────────────────────────────
m5       HSNB (m5)          9.777219935028333  0.19355305042839377  5.396737479215325   None            
m5       NB (m5)            7.845563804829036  0.18073659423351557  6.646977298580728   None            
m5       TWEEDIE_FULL (m5)  7.532817210499032  0.1821886034606037   5.1740883316042865  None            
```
...
level                           gain                
────────────────────────────────────────────────────
origin oracle (m5, diagnostic)  0.008793392721318738
```
...
```
dataset  variant  outer_sCRPS        recovery               selected_lambda  primary_student
────────────────────────────────────────────────────────────────────────────────────────────
m5       A0 (m5)  7.26697084615988   0.0                    0.0              A3             
m5       A1 (m5)  7.389259989518947  -0.016828076780256884  0.25             A3             
m5       A2 (m5)  7.372978133720947  -0.01458754821028152   0.5              A3             
m5       A3 (m5)  7.389259989518947  -0.016828076780256884  0.25             A3             
```
