...
sources in `introduction_v3_claim_audit.md`. Citation keys are placeholders because the
repository contains no bibliography. Supersedes `introduction_v2.md`; v1 and v2 are retained. P1-P6 carry v2's scientific
content unchanged; only P7 was compressed and one clause in P1 tightened.
